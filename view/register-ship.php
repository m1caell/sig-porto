        ...
        <main class="my-main">
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="https://www.publicdomainpictures.net/pictures/110000/nahled/cargo-container-ship.jpg" class="card-img" alt="container">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Cadastro de navio</h5>
                            <form action="../controller/ship-controller.php" method="POST">
                                <div class="form-group">
                                    <label for="exampleInputRegistratios">Matricula</label>
                                    <input name="registration" type="text" class="form-control" id="exampleInputRegistratios" aria-describedby="emailHelp" placeholder="Digite a matricula do navio">
                                </div>
                                <div class="form-group">
